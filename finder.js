  ...
  const solutions = isSimplifiedChinese ? [
    {
      ...
      module: { name: "USB 双通道 CAN FD 适配器", description: "USB 外接硬件", status: "双通道 CAN FD", price: "按配置报价", href: "products/usb-dual-can-fd/#module" },
      controller: { name: "XL1326-A", description: "用于 PCB 的双通道 CAN FD 接口芯片", status: "仅 2 路 CAN FD · LQFP48", price: "样品与批量报价", href: "products/interface-ics/#xl1326-a" }
    },
    {
      id: "mini-pcie-canfd",
      host: "mini-pcie",
      ...
      module: { name: "Mini PCIe 双通道 CAN FD 模块", description: "双路信号隔离内置模块", status: "Windows + Linux", price: "US$69.99", href: "products/mini-pcie-dual-can-fd/" },
      controller: { name: "XL1326-A", description: "用于 PCB 的双通道 CAN FD 接口芯片", status: "仅 2 路 CAN FD · LQFP48", price: "样品与批量报价", href: "products/interface-ics/#xl1326-a" }
    },
    {
      id: "usb-canfd-rs485",
      ...
      module: { name: "USB 双通道 CAN FD + 双通道 RS-485 适配器", description: "USB 外接硬件", status: "混合接口", price: "按配置报价", href: "products/usb-canfd-rs485/#module" },
      controller: { name: "XL1326", description: "用于 PCB 的 8 端口接口芯片", status: "6 个串行 COM + 2 个 CAN FD 端点", price: "样品与批量报价", href: "products/interface-ics/#xl1326" }
    },
    {
      ...
      href: "products/usb-canfd-rs485/",
      module: { name: "Mini PCIe 双通道 CAN FD + 双通道 RS-485 模块", description: "基于 USB 的 Mini PCIe 硬件", status: "混合接口", price: "按配置报价", href: "products/usb-canfd-rs485/#module" },
      controller: { name: "XL1326", description: "用于 PCB 的 8 端口接口芯片", status: "6 个串行 COM + 2 个 CAN FD 端点", price: "样品与批量报价", href: "products/interface-ics/#xl1326" }
    },
    {
      id: "usb-smbus",
      ...
      module: { name: "熙联迈电池显示模块", description: "USB 智能电池接口", status: "Windows + Linux", price: "按电池组报价", href: "products/usb-smbus/" },
      controller: null
    }
  ] : [
    {
      ...
      href: "products/usb-dual-can-fd/",
      module: { name: "USB Dual CAN FD Adapter", description: "USB-connected hardware", status: "Dual CAN FD", price: "Quoted by configuration", href: "products/usb-dual-can-fd/#module" },
      controller: { name: "XL1326-A", description: "Dual CAN FD interface IC for your PCB", status: "2 CAN FD only · LQFP48", price: "Sample and volume pricing", href: "products/interface-ics/#xl1326-a" }
    },
    {
      id: "mini-pcie-canfd",
      host: "mini-pcie",
      ...
      summary: "Add two CAN / CAN FD channels up to 8 Mbit/s with signal isolation and Windows and Linux driver support.",
      href: "products/mini-pcie-dual-can-fd/",
      module: { name: "Mini PCIe Dual CAN FD Module", description: "Isolated dual-channel internal hardware", status: "Windows + Linux", price: "US$69.99", href: "products/mini-pcie-dual-can-fd/" },
      controller: { name: "XL1326-A", description: "Dual CAN FD interface IC for your PCB", status: "2 CAN FD only · LQFP48", price: "Sample and volume pricing", href: "products/interface-ics/#xl1326-a" }
    },
    {
      id: "usb-canfd-rs485",
      ...
      href: "products/usb-canfd-rs485/",
      module: { name: "USB Dual CAN FD + Dual RS-485 Adapter", description: "USB-connected hardware", status: "Multi-interface", price: "Quoted by configuration", href: "products/usb-canfd-rs485/#module" },
      controller: { name: "XL1326", description: "8-port interface IC for your PCB", status: "6 serial COM + 2 CAN FD endpoints", price: "Sample and volume pricing", href: "products/interface-ics/#xl1326" }
    },
    {
      id: "mini-pcie-canfd-rs485",
      host: "mini-pcie",
      ...
      href: "products/usb-canfd-rs485/",
      module: { name: "Mini PCIe Dual CAN FD + Dual RS-485 Module", description: "USB-based Mini PCIe hardware", status: "Multi-interface", price: "Quoted by configuration", href: "products/usb-canfd-rs485/#module" },
      controller: { name: "XL1326", description: "8-port interface IC for your PCB", status: "6 serial COM + 2 CAN FD endpoints", price: "Sample and volume pricing", href: "products/interface-ics/#xl1326" }
    },
    {
      id: "usb-smbus",
      ...
      href: "products/usb-smbus/",
      module: { name: "Xilume Battery Display Module", description: "USB-connected smart-battery interface", status: "Windows + Linux", price: "Configured-to-order pricing", href: "products/usb-smbus/" },
      controller: null
    }
  ];
